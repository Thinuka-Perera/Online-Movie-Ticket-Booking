  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      <div className={`max-md:absolute max-md:top-0 max-md:left-0 max-md:font-medium
        ...
        <div className='flex items-center gap-8'>
...

          {
            !user ? (
              ...
              <button onClick={openSignIn} className='px-4 py-1 sm:px-7 sm:py-2 bg-primary hover:big-primary-dull 
            ...
            (  
              <UserButton>
                <UserButton.MenuItems>
                  <UserButton.Action label='My Bookings' labelIcon={ <TicketPlus width={15}></TicketPlus>} onClick={()=> navigate('/my-bookings')}/>
                </UserButton.MenuItems>
              </UserButton>
            )
          }
        ...
        <MenuIcon className='max-md:ml-4 md:hidden w-8 h-8 cursor-pointer' onClick={()=>setIsOpen(!isOpen)}></MenuIcon>
